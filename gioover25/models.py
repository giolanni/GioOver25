...
class TeamStats:
    ...
    def last10_over_rate(self) -> float:
        return self.last10_over25 / self.played if self.played else 0.0

    @property
    def last10_gf_per_match(self) -> float:
        return self.last10_goals_for / self.played if self.played else 0.0

    @property
    def last10_ga_per_match(self) -> float:
        return self.last10_goals_against / self.played if self.played else 0.0
